...
<div x-data="transactionPanel" 
    ...
    <div x-show="open" class="relative z-50">
        ...
        <div x-show="open" 
            ...
            class="fixed inset-0 transition-opacity"></div>
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="text-left">
                            ...
                            ${data.payment_status === 'paid' || data.payment_status === 'settlement' ? `
                                <div class="mt-4 text-center">
                                    <a href="/transactions/${data.id}/invoice" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
