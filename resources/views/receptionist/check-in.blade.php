                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            @if($booking->checked_in_at)
                                                <div class="inline-flex items-center px-3 py-1.5 rounded-md bg-blue-500/10 border border-blue-500/20">
                                                    <span class="text-blue-400">Sudah Check In</span>
                                                    <span class="text-xs text-gray-400 ml-2">{{ $booking->checked_in_at->format('d/m/Y H:i') }}</span>
                                                </div>
                                            @else
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 text-center text-gray-400">
                                            Tidak ada tamu yang perlu check-in.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
