                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span class="px-2 py-1 text-xs font-medium rounded-full
                                                @if($booking->status === 'checked_in') bg-blue-500/10 text-blue-400 border border-blue-500/20
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form action="{{ route('receptionist.check-out.process', $booking) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="text-amber-400 hover:text-amber-300 bg-amber-500/10 px-3 py-1 rounded-lg border border-amber-500/20">
                                                    Check-out
                                                </button>
                                            </form>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="px-6 py-4 text-center text-gray-400">
                                            Tidak ada tamu yang perlu check-out hari ini.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
