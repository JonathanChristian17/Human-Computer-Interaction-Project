                ...
                <div class="p-6">
                    <form action="{{ route('admin.rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 needs-confirm">
                        ...
                        <div>
                            ...
                            <x-text-input id="number" name="number" type="text" class="mt-1 block w-full bg-[#1D1D1D] border-[#FFA040] text-white" :value="old('number', $room->room_number)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full bg-[#1D1D1D] border-[#FFA040] text-white" :value="old('name', $room->name)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="price_per_night" name="price_per_night" type="text" class="mt-1 block w-full bg-[#1D1D1D] border-[#FFA040] text-white" :value="old('price_per_night', number_format($room->price_per_night, 0, ',', '.'))" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="capacity" name="capacity" type="number" min="1" class="mt-1 block w-full bg-[#1D1D1D] border-[#FFA040] text-white" :value="old('capacity', $room->capacity)" required />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-md bg-[#1D1D1D] border-[#FFA040] text-white focus:border-[#FFA040] focus:ring-[#FFA040]" required>{{ old('description', $room->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="file" id="image" name="image" accept="image/*" class="mt-1 block w-full text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#FFA040] file:text-white hover:file:bg-[#ff8c1a]" onchange="previewImage(this)" />
